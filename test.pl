...
my $cmp_value = system("grep -w -A 1 'output_reporting_data_filters_viewtype add external vvvv' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system(" grep -i -A 1 'output_reporting_data_filters_member add external mmmm' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -w  'admin_support_access set on' serial-automation.log");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_hostname set admin' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_domain set testing.com' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep  -i -A 3 'input_scp_users add admin' serial-automation.log");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep  'Unregistering Data Collector VM with the Grid... done.' serial-automation.log");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep  'grid_sync' serial-automation.log");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1  'admin_network_route set address=10.34.24.1 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.2 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1  'admin_network_route set address=10.34.24.3 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.4 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.5 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.6 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.7 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.8 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.9 mask=255.255.255.255 gateway=10.' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.10 mask=255.255.255.255 gateway=1' serial-automation.log | grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.11 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.12 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.13 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.14 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.15 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.16 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.17 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.18 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.19 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.20 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.21 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.22 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.23 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.24 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.25 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.26 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.27 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.28 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.29 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.30 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -i -A 1 'admin_network_route set address=10.34.24.31 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep  'admin_network_route set address=10.34.24.32 mask=255.255.255.255 gateway=1' serial-automation.log| grep 'ok'");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -m '1' 'admin_support_restore set' serial-automation.log");
if ( $cmp_value == 0 )
{
...
my $cmp_value = system("grep -m '1' 'admin_support_restore del' serial-automation.log");
if ( $cmp_value == 0 )
{
